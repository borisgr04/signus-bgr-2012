...
Public Class DBMenu
    ...
    End Sub
    'cargar -> Menu
    Public Sub cargarMenu(ByVal mn As Menu)
    ...
    Public Sub cargarElementos(ByRef tvw As TreeView, ByVal perfil As String)
        tvw.Nodes.Clear()
        Dim dtMenuItems As New DataTable
        Dim queryString As String
        'Conexion a la base de datos donde esta nuestra tabla Menú.
    ...
    Private Sub AddMenuItem(ByRef mnuMenuItem As TreeNode, ByVal dtMenuItems As DataTable)
        'recorremos cada elemento del datatable para poder determinar cuales son elementos hijos
        'del menuitem dado pasado como parametro ByRef.
        For Each drMenuItem As Data.DataRow In dtMenuItems.Rows
            If drMenuItem("PadreId").ToString.Equals(mnuMenuItem.Value) AndAlso _
    ...
    Public Sub GetOpcionesPorUser(ByRef tvw As TreeView, ByVal username As String)
        tvw.Nodes.Clear()
        Dim dtMenuItems As New DataTable
        Dim queryString As String
        'Conexion a la base de datos donde esta nuestra tabla Menú.
        ...
        Me.Desconectar()
    End Sub
    Private Sub AddMenuItemPorUser(ByRef mnuMenuItem As TreeNode, ByVal dtMenuItems As DataTable, ByVal username As String)
        'recorremos cada elemento del datatable para poder determinar cuales son elementos hijos
        'del menuitem dado pasado como parametro ByRef.
    ...
    Public Function AgregarPerfil(ByVal Tvw As TreeView, ByVal nomper As String) As String
    ...
    '--------------------------------------
    Private Function Opciones_Seleccionadas(ByVal Tvw As TreeView) As String
        Dim str As String = ""
