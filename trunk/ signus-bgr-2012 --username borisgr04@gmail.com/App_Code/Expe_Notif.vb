...
Public Class Expe_Notif
    ...
    Public Function Insert(ByVal EXNF_FREB As String, ByVal EXNF_NOTIF As String, ByVal EXNF_MEDIO As String, ByVal EXNF_FENV As String, ByVal EXNF_REC As String, ByVal EXNF_OBS As String, ByVal EXNF_EMM As String, ByVal EXTR_NUME As String, ByVal EXTR_TRAC As String, ByVal EXTR_GUIA As String) As String
        Dim na As String

        Me.Conectar()
        Try
            ComenzarTransaccion()
            Me.querystring = "INSERT INTO EXPE_NOTIF(EXNF_FREB, EXNF_NOTIF, EXNF_MEDIO, EXNF_FENV, EXNF_REC, EXNF_OBS, EXNF_EMM, EXTR_NUME, EXTR_GUIA, EXTR_TRAC, EXTR_USAP) "
            Me.querystring += " VALUES(:EXNF_FREB, :EXNF_NOTIF, :EXNF_MEDIO, :EXNF_FENV, :EXNF_REC, :EXNF_OBS, :EXNF_EMM, :EXTR_NUME, :EXTR_GUIA, :EXTR_TRAC, :USER_AP_CR)"
            CrearComando(querystring)
            AsignarParametroCadena(":EXNF_FREB", EXNF_FREB)
            AsignarParametroCadena(":EXNF_NOTIF", EXNF_NOTIF)
            AsignarParametroCadena(":EXNF_MEDIO", EXNF_MEDIO)
            AsignarParametroCadena(":EXNF_FENV", EXNF_FENV)
