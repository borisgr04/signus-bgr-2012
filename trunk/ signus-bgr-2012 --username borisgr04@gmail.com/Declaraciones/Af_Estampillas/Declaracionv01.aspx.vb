...
Partial Class Declaraciones_Af_Estampillas_Declaracionv01
    ...
    Private Sub Cargar_datos()
        Try
            ...
            Me.HdEsDec.Value = "N"
            Me.HdNumExpe.Value = querystringSeguro("EXPE_NUME")
        ...
        Me.ReportViewer1.LocalReport.ReportPath = Me.Server.MapPath("~") + "\Af_" + dtForm.Rows(0)("FODE_RPTE").ToString.Trim
        ...
        Me.Opcion = UCase("Liquidación Oficial de Aforo para la declaración de ") + objCd.GetNomDec(Me.Cla_Dec.Value)
    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            Dim CVMM As String = objCd.GetCVMMLA(Me.HdFecLim.Value)
            If (CVMM = "S") Then
            ...
            If HdTICO.Value = "S" Then
                ...
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.HdTD.Value = "C") Then
                    If CDbl(txtR.Text.Replace("$", "")) < CDbl(Me.HdSancionMinima.Value) Then
                        Me.MsgResult.Text = "<B>" + "</b><br>Valor de la Sanción debe ser mayor  o igual a la sanción minima " + Me.HdSancionMinima.Value + txtR.Text.Replace("$", "")
                        Me.ModalPopup.Show()
                        Return False
                    End If
    ...
    Private Sub IrAtras()
        ...
        querystringSeguro("numExp") = HdNumExpe.Value
    ...
    Function Guardar_Dec() As Boolean
        ...
        'AQUI ACTUALIZAR EN EXPEDIENTES EL NUMERO DE LIQUIDACION Q SE GENERO 
        If Not objCd.lErrorG Then
            Dim oApg As New Expe_Apg
            MsgResult.Text = oApg.UpdateNumLiquidacion(Dec_Cod, HdNumExpe.Value, Me.AGravable.Text, Me.PGravable.Text, Me.Cla_Dec.Value)
        End If
    ...
    Protected Sub BtnGPDF_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnGPDF.Click
        Me.Cargar_Rpt()
    End Sub
    ...
    Protected Sub BtnLiq_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnLiq.Click
        ...
        objCd = New CDeclaraciones(Me.Cla_Dec.Value)
        Me.Liquidar()
        BtnGPDF.Enabled = True
        BtnGuardarD.Enabled = True
    End Sub
    ...
    Public Function Liquidar() As Boolean
        ...
        For i As Integer = 0 To Cant - 1
            ...
            If HdIsVB.Value = "S" Then
                ...
                'LiqP(i).CODE_VABA = CDec(TxtValBas.Text.Replace("$", "").Replace(".", ""))
                LiqP(i).CODE_IMPTO = HdCimp.Value
                LiqP(i).CODE_TARI = HdTari.Value
            Else
                LiqP(i).CODE_VABA = Nothing
            ...
            Else
                LiqP(i).CODE_VADE = CDbl(txtR.Text.Replace("$", ""))
                'LiqP(i).CODE_VADE = CDbl(txtR.Text.Replace("$", "").Replace(".", ""))
            End If
            'SI ES SANCIÓN
            If HdTICO.Value = "S" Then
                LiqP(i).CODE_TSAN = CboTSan.SelectedValue
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.HdTD.Value = "C") Then
                    Select Case CboTSan.SelectedValue
                        Case "00"
                            Me.MsgResult.Text = "Debe Seleccionar el Tipo de Sanción de la Liquidación "
                            Me.ModalPopup.Show()
                            Return False
                        Case "01"
