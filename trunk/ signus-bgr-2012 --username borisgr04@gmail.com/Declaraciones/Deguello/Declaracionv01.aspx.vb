...
Partial Class Declaraciones_Deguello_Declaracionv01
    ...
    Property NFormulario() As String
        Get
            Return ViewState("NFormulario")
        End Get
        Set(ByVal value As String)
            ViewState("NFormulario") = value
        End Set
    End Property
            ...
            If HdTICO.Value = "S" Then
                ...
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Or (Me.HdTD.Value = "C") Then
                    If CDbl(txtR.Text.Replace("$", "")) < CDbl(Me.HdSancionMinima.Value) Then
                        Me.MsgResult.Text = "<B>" + "</b><br>Valor de la Sanción debe ser mayor  o igual a la sanción minima [" + FormatCurrency(Me.HdSancionMinima.Value) + "]"
                        Me.ModalPopup.Show()
                        Return False
                    End If
