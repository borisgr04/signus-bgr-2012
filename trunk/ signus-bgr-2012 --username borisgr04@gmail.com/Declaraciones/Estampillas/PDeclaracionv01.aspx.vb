...
Partial Class Declaraciones_Estampillas_PDeclaracionv01
    ...
    Private Function GetDatosP() As DataSet
        ...
        Dim obj As CDeclaraciones = New CDeclaraciones(Me.Cla_Dec.Value)
        dt = obj.GetDeclaracionRpt("20104000003")
        Return dt
    End Function
    ...
    Protected Sub BtnGPDF_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Me.Cargar_Rpt()
        Mail.EnviarAuto("Prueba de Declaración:[" + Membership.GetUser.UserName + "]" + Now.ToLongTimeString, "Hola")
    End Sub
