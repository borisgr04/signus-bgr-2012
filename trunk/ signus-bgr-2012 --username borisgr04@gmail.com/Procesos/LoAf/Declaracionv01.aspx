<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Declaracionv01.aspx.vb" Inherits="Declaraciones_Estampillas_Declaracionv01" %>
...
<body scroll="yes">
    <form id="form1" runat="server" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        ...
        <table width="100%" class="tbHeaderDec">
            ...
            <tr>
                ...
                <td style="width: 457px; text-align: right">
                    <asp:Label ID="Label23" runat="server" Font-Bold="True">Estampilla ProDesarrollo Departamental</asp:Label></td>
            </tr>
            <tr>
                <td style="width: 457px; text-align: right">
                    <asp:Label ID="Label24" runat="server" Font-Bold="True">Estampilla ProDesarrollo Fronterizo</asp:Label></td>
            </tr>
            <tr>
                <td style="width: 457px; text-align: right">
                    <asp:Label ID="Label26" runat="server" Font-Bold="True">Estampilla ProCultura</asp:Label></td>
            </tr>
        </table>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 300px; ">
                                ...
                                <asp:DropDownList ID="CboTSan" style="accelerator:true; font-size:7pt; " runat="server" DataSourceID="ObjTSANCIONES" DataTextField="TSAN_NOM" DataValueField="TSAN_COD" Visible=<%#IIF(DataBinder.Eval(Container.DataItem, "COCD_TICO")="S",True,False)%>>
                                 </asp:DropDownList></td>
                            </td>
        ...
        &nbsp;
        <asp:ObjectDataSource ID="ObjTSANCIONES" runat="server" SelectMethod="GetRecordsLO"
        ...
        <asp:HiddenField ID="HdFecDec" runat="server" />
        <br />
        <br />
