    ...
    <div class="DecHeader">
        <div class="DecHeader">
            ...
            <asp:UpdatePanel id="UpdatePanel1" runat="server">
                <contenttemplate>
<TABLE><TBODY><TR><TD colSpan=2><asp:Label id="LbClaseDec" runat="server" Width="261px" Font-Bold="True" CssClass="TitDecl" __designer:wfdid="w106" Text="SELECCIONE LA CLASE DE DECLARACION"></asp:Label></TD><TD style="WIDTH: 100px"><asp:Label id="Label1" runat="server" Width="151px" Font-Bold="True" CssClass="TitDecl" __designer:wfdid="w1" Text="FECHA INICIAL"></asp:Label></TD><TD style="WIDTH: 100px"><asp:Label id="Label2" runat="server" Width="151px" Font-Bold="True" CssClass="TitDecl" __designer:wfdid="w2" Text="FECHA FINAL"></asp:Label></TD></TR><TR><TD colSpan=2><asp:DropDownList id="CbCdec" runat="server" __designer:wfdid="w107" DataSourceID="ObjCDec" AutoPostBack="True" DataTextField="CLD_NOM" DataValueField="CLD_COD">
                            </asp:DropDownList></TD><TD style="WIDTH: 100px"><asp:TextBox id="TxtFI" runat="server" __designer:wfdid="w109"></asp:TextBox></TD><TD style="WIDTH: 100px"><asp:TextBox id="TxtFF" runat="server" __designer:wfdid="w110"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px"></TD></TR></TBODY></TABLE>&nbsp;<BR />Consulta Detallada por Periodo<asp:Button id="BtnExcel" onclick="BtnExcel_Click" runat="server" __designer:wfdid="w103" Text="Export Excel"></asp:Button><BR /><asp:GridView id="grConc" runat="server" Width="100%" __designer:wfdid="w104" DataSourceID="ObjDCartD" GridLines="Vertical" AllowSorting="True" AllowPaging="True"><Columns>
<asp:CommandField ShowSelectButton="True"></asp:CommandField>
</Columns>
</asp:GridView> <asp:ObjectDataSource id="ObjDCartD" runat="server" __designer:dtid="1125899906842659" TypeName="Informes" SelectMethod="GetSaldosPorConc" OldValuesParameterFormatString="original_{0}" __designer:wfdid="w105"><SelectParameters __designer:dtid="1125899906842660">
<asp:ControlParameter ControlID="CbCdec" PropertyName="SelectedValue" DefaultValue="" Name="Dec_Cdec"></asp:ControlParameter>
