    ...
    <b>PASOS PARA DILIGENCIAR FORMULARIO DE DECLARACIÓN</b>.</td>
        ...
        <tr>
            <td>
                ...
                Estampillas
                , Degüello, Registro. <asp:HyperLink ID="HyperLink7" runat="server" 
                    NavigateUrl="~/Formatos_Excel_Declaraciones/Formatos/fmt_declaraciones.xls"> Descargue aquí </asp:HyperLink></td>
        </tr>
        <tr>
            <td class="TdIzq">
                &nbsp;</td>
