...
</asp:GridView></DIV><BR /><DIV id="GRID"><asp:ObjectDataSource id="ObjTerceros" runat="server" TypeName="Terceros" SelectMethod="GetRecords" OldValuesParameterFormatString="original_{0}"><SelectParameters>
