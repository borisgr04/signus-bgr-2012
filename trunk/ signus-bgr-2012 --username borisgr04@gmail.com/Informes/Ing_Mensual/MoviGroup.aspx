<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="MoviGroup.aspx.vb" Inherits="Informes_MoviGroup" title="Untitled Page"  UICulture="auto" Culture="auto"%>
...
<div class="demoarea"> 
    <div class="demoarea">
        <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnableScriptGlobalization="true"
            ...
            Text="Consulta de Ingresos" Font-Bold="False"></asp:Label>
...
&nbsp; <asp:Label id="MsgResult" runat="server"></asp:Label> 
                    <TABLE style="WIDTH: 645px; HEIGHT: 57px" id="Table2"><TBODY><TR>
                        ...
                        <tr>
                            <td style="WIDTH: 119px; HEIGHT: 7px; TEXT-ALIGN: left">
                                <asp:CheckBox ID="CBFEC" runat="server" Checked="True" Text="Fecha Inicial" />
                            </td>
                            <td colspan="2" style="WIDTH: 76px; HEIGHT: 7px">
                                <asp:TextBox ID="TFI" runat="server" Width="95px"></asp:TextBox>
                                <asp:CustomValidator ID="ValCutFI" runat="server" __designer:wfdid="w1" 
                            ...
                            <td style="WIDTH: 95px; HEIGHT: 7px; TEXT-ALIGN: right">
                                ...
                                <asp:CustomValidator ID="ValCutFF" runat="server" __designer:wfdid="w3" 
                        ...
                        <TR><TD style="HEIGHT: 33px; TEXT-ALIGN: center; background-color: #F0F0F0;" 
                            ...
                            <asp:RadioButtonList ID="Tipo_Grupo" runat="server" 
                                ...
                                <asp:ListItem Selected="True" Value="D">AGRUPAR POR AÑO Y PERIODO DE DECLARACION</asp:ListItem>
                                <asp:ListItem Value="I">AGRUPAR POR AÑO Y PERIODO DE INGRESO</asp:ListItem>
                            </asp:RadioButtonList>
                            </TD></TR>
                        <tr>
                            <td style="WIDTH: 119px; HEIGHT: 33px; TEXT-ALIGN: left">
                                <asp:CheckBox ID="CBANO" runat="server" Checked="True" Text="Año" />
                                &nbsp;
                            </td>
                            ...
                            <td style="WIDTH: 95px; HEIGHT: 33px; TEXT-ALIGN: right">
                                <asp:CheckBox ID="cbMes" runat="server" Checked="True" Text="Periodo" 
                                    Width="73px" />
                            </td>
                            <td style="WIDTH: 95px; HEIGHT: 33px; TEXT-ALIGN: right">
                        ...
                        <TR><TD style="HEIGHT: 24px; TEXT-ALIGN: left; font-weight: 700; background-color: #F0F0F0;" 
                                colspan="5">
                            <asp:CheckBox ID="CBCTA" runat="server" Checked="True" 
                        ...
                        <TR><TD style="HEIGHT: 24px; TEXT-ALIGN: left; font-weight: 700; background-color: #F0F0F0;" 
                                colspan="5">
                            <asp:CheckBox ID="CBCON" runat="server" Checked="True" 
                        ...
                        <TR><TD style="WIDTH: 119px; HEIGHT: 24px; TEXT-ALIGN: right"></TD>
                            <TD style="WIDTH: 76px; HEIGHT: 24px" colspan="2">&nbsp;</TD><TD style="WIDTH: 95px; HEIGHT: 24px">
                            &nbsp;</TD><TD style="WIDTH: 95px; HEIGHT: 24px"></TD></TR><TR>
                        <TD style="WIDTH: 119px; HEIGHT: 24px; TEXT-ALIGN: right"></TD>
                        ...
                        &nbsp;</TD></TR><TR><TD style="WIDTH: 119px; HEIGHT: 24px; TEXT-ALIGN: right"></TD>
                            <TD style="WIDTH: 76px; HEIGHT: 24px; text-align: center;">
