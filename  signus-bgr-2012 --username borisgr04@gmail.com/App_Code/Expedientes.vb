...
Public Class Expedientes
    ...
    <DataObjectMethodAttribute(DataObjectMethodType.Select, True)> _
    Public Function GetListaOmisosSinExpediente(ByVal Per_Ini As String, ByVal Per_Fin As String, ByVal Vig_Ini As String, ByVal Vig_Fin As String, ByVal Impuesto As String, Optional ByVal Nit As String = "", Optional ByVal CodMpio As String = "") As DataTable
