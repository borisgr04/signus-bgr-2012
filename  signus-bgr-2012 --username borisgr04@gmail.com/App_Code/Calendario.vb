...
Public Class Calendario
    ...
    Public Overloads Function GetPorFechaIni(ByVal Cla_Dec As String, ByVal Vig_Ini As String, ByVal Vig_Fin As String, ByVal Fec_ini As String) As DataTable
        ...
        Me.Conectar()
        Me.querystring = "select CAL_PER, cal_des, cal_vig from calendario where cal_vig >= :Vig_Ini and cal_vig <= :Vig_Fin and cal_cla= :Cla_Dec and  last_day(cal_fini) >= :Fec_ini  And Cal_Ffin<SYSDATE order by cal_vig, cal_per"
        CrearComando(querystring)
