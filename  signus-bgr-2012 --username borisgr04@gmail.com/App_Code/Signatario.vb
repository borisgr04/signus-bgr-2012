...
Public Class Signatario
    ...
    ''' <summary>
    ''' 'Modificada por Boris el 12 Febrero de 2012,
    ''' Se quito filtr x Digito de Verificacón
    ''' </summary>
    ''' <param name="OldNit"></param>
    ''' <param name="OldDver"></param>
    ''' <param name="REL_TDOC"></param>
    ''' <param name="REL_AGE"></param>
    ''' <param name="REL_DVER"></param>
    ''' <param name="REL_TDOCREV"></param>
    ''' <param name="REL_REV"></param>
    ''' <param name="REL_TREV"></param>
    ''' <param name="REL_TARPRO"></param>
    ''' <param name="REL_TDOCDEC"></param>
    ''' <param name="REL_DEC"></param>
    ''' <param name="REL_TDEC"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
