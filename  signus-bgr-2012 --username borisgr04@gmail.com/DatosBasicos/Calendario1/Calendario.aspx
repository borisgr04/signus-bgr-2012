...
<div class="demoarea">
    ...
    <asp:UpdatePanel id="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <contenttemplate>
<asp:Label id="Tit" runat="server" Width="286px" CssClass="Titulo" Text="Calendario Tributario" __designer:wfdid="w360"></asp:Label> <BR /><asp:Label id="MsgResult" runat="server" Text="XXXXXXXXX" __designer:wfdid="w361"></asp:Label><asp:TextBox id="TxtCDec" runat="server" Width="71px" __designer:wfdid="w362" Visible="False"></asp:TextBox> <TABLE><TBODY><TR><TD style="WIDTH: 100px">Clase Declaración</TD><TD style="WIDTH: 100px">Año Gravable</TD><TD style="WIDTH: 100px">Periodo Gravable</TD><TD style="WIDTH: 100px"></TD><TD style="WIDTH: 100px"></TD></TR><TR><TD style="WIDTH: 100px"><asp:DropDownList id="CMBCLADEC" runat="server" Width="253px" __designer:wfdid="w4" DataSourceID="ObjClaseDec" DataValueField="cld_cod" DataTextField="cld_nom" AutoPostBack="True"></asp:DropDownList></TD><TD style="WIDTH: 100px"><asp:TextBox id="TxtA" runat="server" Width="71px" __designer:wfdid="w363"></asp:TextBox></TD><TD style="WIDTH: 100px"><asp:TextBox id="TxtP" runat="server" Width="82px" __designer:wfdid="w364"></asp:TextBox></TD><TD style="WIDTH: 100px"><asp:Button id="BtnFiltrar" onclick="BtnFiltrar_Click" runat="server" Width="71px" __designer:dtid="1970324836974596" Text="Filtrar" __designer:wfdid="w365"></asp:Button></TD><TD style="WIDTH: 100px"><asp:Button id="BtnQuitarF" onclick="BtnQuitarF_Click" runat="server" Text="Quitar Filtro" __designer:wfdid="w366"></asp:Button></TD></TR><TR><TD style="HEIGHT: 19px" colSpan=2><asp:Label id="Label8" runat="server" Text="N° de Registros a mostrar" __designer:wfdid="w414"></asp:Label></TD><TD style="WIDTH: 100px; HEIGHT: 19px"><asp:TextBox id="TxtNReg" runat="server" Width="82px" __designer:wfdid="w412"></asp:TextBox></TD><TD style="WIDTH: 100px; HEIGHT: 19px"><asp:Button id="BtnNReg" onclick="BtnNReg_Click" runat="server" Text="Actualizar" __designer:wfdid="w415"></asp:Button></TD><TD style="WIDTH: 100px; HEIGHT: 19px"></TD></TR></TBODY></TABLE><BR /><asp:GridView id="GridView1" runat="server" Width="822px" ForeColor="#333333" __designer:wfdid="w321" EmptyDataText="No se encontraron Registros en la Base de Datos" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" DataKeyNames="CAL_PER,CAL_VIG,CAL_CLA" OnRowCommand="GridView1_RowCommand" ShowFooter="True" CellPadding="4" GridLines="None" DataSourceID="Objcale" AllowPaging="True" OnRowDataBound="GridView1_RowDataBound1" AllowSorting="True" PageSize="12">
