...
Partial Class Declaraciones_Estampillas_Declaracionv01
    ...
    Private Sub Cargar_datos()
        Try
            ...
            Me.HdDecTip.Value = "01" 'querystringSeguro("DecTip")
            Me.TD = "I" 'querystringSeguro("TD")
            Me.HdTD.Value = "I" 'querystringSeguro("TD")
        ...
        Me.Dias_Mora = DateDiff(DateInterval.Day, fecha_lim, Now)
        Me.HdSancionMinima.Value = objCd.GetSancion_Minima(fecha_lim)
        Dim str As String
        If (fecha_lim < Now) Then
            Me.HdExtem.Value = "S"
            ...
            Else
                str = "Realizará una Declaración de Corrección, debe declarar Sanciones y Liquidar Intereses de Mora del Valor no Pagado"
            End If
        ...
        Me.ReportViewer1.LocalReport.ReportPath = dtForm.Rows(0)("FODE_RPTE").ToString.Trim

        'Me.LbPGravable.Text = dtForm.Rows(0)("FODE_RPTE").ToString.Trim
        If Me.TD = "C" Then
            Me.TxtDecCorrige.Text = dec_cor
        End If
        If Me.HdDecTip.Value = "01" Then
            Me.DInicial.Checked = True
        Else
            Me.DCorr.Checked = True
        End If
        Me.Opcion = objCd.GetNomDec(Me.Cla_Dec.Value)
    ...
    Public Function DiasMora(ByVal Fecha As Date) As Integer
        ...
        Return DateDiff(DateInterval.Day, fecha_lim, Now)
    End Function
    ...
    Private Sub RenderReport(ByVal Rpt As LocalReport)
        ...
        Response.AddHeader("content-disposition", "attachment; filename=Declaracion." & fileNameExtension)
    ...
    Private Sub IrAtras()
        Response.Redirect("~/declaraciones/diligenciar/seldec.aspx")
    End Sub
    ...
    Function Guardar_Dec() As Boolean
        ...
        Me.TD = Me.HdTD.Value
        MsgResult.Text = objCd.Insert(Dec_Cod, dec_cdec, Me.Identificaciòn.Text, Me.DV.Text.Trim, AGravable.Text, PGravable.Text, Me.TxtDecCorrige.Text, DEC_TRET, DEC_CSAN, DEC_TSAN, dec_tot, DEC_PRS, DEC_PIM, DEC_PTOT, Tip_Decla, Me.Agente.Text, Dec_FDCO, Dec_Fven, Me.TD, aLp, TIPO_DOC)
