...
Partial Class Seguridad_Usuarios_Cam_CambCont_us
    ...
    Protected Sub BtnReiniciarUsuario_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnReiniciarUsuario.Click
        Dim obj As Usuarios = New Usuarios
        Me.LMSgBox.Text = obj.RegenerarUsuario(Me.Tus.Text, Me.Tcont.Text)
        Me.MsgBox(Me.LMSgBox, obj.lErrorG)
    End Sub
End Class
