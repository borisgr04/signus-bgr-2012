...
&nbsp; <asp:Label id="MsgResult" runat="server" __designer:wfdid="w182"></asp:Label>&nbsp;<BR /><TABLE style="WIDTH: 441px; HEIGHT: 57px" id="Table2"><TBODY><TR><TD style="WIDTH: 72px; HEIGHT: 7px; TEXT-ALIGN: right">
                        ...
                        <td colspan="3" style="HEIGHT: 33px; TEXT-ALIGN: left">
                            ...
                            &nbsp;</TD></TR></TBODY></TABLE>&nbsp; <BR /><ajaxToolkit:CalendarExtender id="CalendarExtender1" runat="server" TargetControlID="TFI" __designer:wfdid="w211"></ajaxToolkit:CalendarExtender><ajaxToolkit:CalendarExtender id="CalendarExtender2" runat="server" TargetControlID="TFF" __designer:wfdid="w212"></ajaxToolkit:CalendarExtender> 
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="View1" runat="server">
                    <rsweb:reportviewer id="Rptview" runat="server" font-names="Verdana" font-size="8pt"
                        height="434px" width="900px">
                        <LocalReport ReportPath="Report\Consultas\RptIngAgen.rdlc">
