            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Observaci&#243;n" SortExpression="TER_OBS">
                  ...
                  <asp:TemplateField >
                    ...
                    <ItemTemplate>
                        <img alt="Enviar" title='Seleccionar Tercero' onmouseover="this.style.cursor = 'hand'" onmouseout="this.style.cursor = 'auto'" src="../../images/Operaciones/Select.png" onclick="javascript:enviar('<%# Eval("TER_TDOC") %>','<%# Eval("TER_NIT") %>','<%# Eval("TER_DVER") %>','<%# Eval("TER_NOM") %>','<%= Me.Ret %>');"  />
                     </ItemTemplate>
                 </asp:TemplateField>
