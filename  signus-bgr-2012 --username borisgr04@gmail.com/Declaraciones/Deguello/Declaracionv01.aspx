<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Declaracionv01.aspx.vb" Inherits="Declaraciones_Deguello_Declaracionv01" %>
...
<body scroll="yes">
    <form id="form1" runat="server" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        ...
        <table width="100%" class="tbHeaderDec">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label22" runat="server" Font-Bold="True" Text="Formulario único para declaración Impuesto de Degüello Ganado Mayor"></asp:Label></td>
            </tr>
            <tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 150px;  text-align: right" >
                                <ew:numericbox id="TxtValBas" runat="server" autoformatcurrency="False" cssclass="TxtNum" Text="0" 
        ...
        <asp:HiddenField ID="HdDOAD" runat="server" /><asp:HiddenField ID="HdFECPRE_INI" runat="server" />
