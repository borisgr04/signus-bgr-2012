<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Declaracionv01.aspx.vb" Inherits="Declaraciones_Af_Estampillas_Declaracionv01" %>
...
<body scroll="yes">
    <form id="form1" runat="server" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        ...
        <div  style="width:100%;height:1000px; margin:0 auto 0 auto;border:solid 0,5pt;overflow:scroll;" > &nbsp;<div class="DecHeaderP">
        ...
        <table width="100%" class="tbHeaderDec">
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label22" runat="server" Font-Bold="True" Text="Liquidación Oficial de Aforo del Impuesto de Estampillas Departamentales"></asp:Label></td>
            </tr>
            <tr>
        ...
        <div class="datasheet">
                    ...
                    <HeaderTemplate>
                            <table class="datatable" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="7"><b>III. LIQUIDACIÓN OFICIAL</b></td>
                                </tr>
                                <tr>
                                    <td class="center">&nbsp;</td>
                                    <td class="center">&nbsp;</td>
        ...
        <asp:ObjectDataSource ID="ObjTSANCIONES" runat="server" SelectMethod="GetRecords"
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="HdEsDec" Name="Es_Dec" PropertyName="Value" />
            </SelectParameters>
        </asp:ObjectDataSource>
        ...
        <asp:HiddenField ID="HdTot" runat="server" />
        
        <asp:HiddenField ID="HdTD" runat="server" /><asp:HiddenField ID="HdDecTip" runat="server" />
        <asp:HiddenField ID="HdEsDec" runat="server" />
        ...
        <asp:HiddenField ID="HdNumExpe" runat="server" />  
       <br />
        <br />
                        ...
                        <div style="vertical-align: middle; width: 100%; height: 73%; text-align: center">
                            <p>
                                <table>
                                    <tr>
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="BtnLiq" runat="server" ImageUrl="~/images/BotonesWeb/BtnLiq.png" ToolTip="Liquidar Sanciones e Interéses" /></td>
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="BtnGuardarD" runat="server" ImageUrl="~/images/BotonesWeb/BtGDec.png"  ToolTip="Guardar Formulario de Declaración" /></td>
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="BtnGPDF" runat="server" ImageUrl="~/images/BotonesWeb/BtnGenPDF.png" Enabled="False" ToolTip="Generar Documento PDF para Impresión y entrega en Entidad Recaudadora" /></td>
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="BtnIrAtras" runat="server" ImageUrl="~/images/BotonesWeb/BtnAtras.png" ToolTip="Ir a Atrás " /></td>
                                    </tr>
                                </table>
                            </p>
                        </div>
