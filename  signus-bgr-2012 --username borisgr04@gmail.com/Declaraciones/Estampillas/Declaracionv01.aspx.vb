...
Partial Class Declaraciones_Estampillas_Declaracionv01
    ...
    Property TD() As String
        ...
        End Set
    End Property
    WriteOnly Property EnableBtnLiq() As Boolean
        Set(ByVal value As Boolean)
            If value = True Then
                Me.BtnLiq.ImageUrl = "~/images/BotonesWeb/BtnLiq.png"
            Else
                Me.BtnLiq.ImageUrl = "~/images/BotonesWeb/BtnLiqDes.png"
            End If
            Me.BtnLiq.Enabled = value

        End Set
    End Property
    WriteOnly Property EnableBtnGuardarD() As Boolean
        Set(ByVal value As Boolean)
            If value = True Then
            ...
            End If
            Me.BtnGuardarD.Enabled = value
        End Set
    End Property

    WriteOnly Property EnableBtnIrAtras() As Boolean
        Set(ByVal value As Boolean)
            If value = True Then
                Me.BtnIrAtras.ImageUrl = "~/images/BotonesWeb/BtnAtras.png"
            Else
                Me.BtnIrAtras.ImageUrl = "~/images/BotonesWeb/BtnAtrasDes.png"
            End If
            Me.BtnIrAtras.Enabled = value
        End Set
    End Property

    WriteOnly Property EnableBtnGPDF() As Boolean
        Set(ByVal value As Boolean)
            If value = True Then
                Me.BtnGPDF.ImageUrl = "~/images/BotonesWeb/BtnGenPDF.png"
            Else
                Me.BtnGPDF.ImageUrl = "~/images/BotonesWeb/BtnGenPDFDes.png"
            End If
            Me.BtnGPDF.Enabled = value
        End Set
    End Property
    '~/images/BotonesWeb/BtnLiq.png
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.EnableBtnLiq = True
            Me.EnableBtnGuardarD = False

            Me.EnableBtnGPDF = False


            Me.Opcion = "Estampillas Departamentales"
            Me.SetTitulo()
    ...
    Private Sub Cargar_datos()
        ...
        'Me.Label2.Text = fecha_lim.ToString + "#" + Me.Dias_Mora.ToString
        ...
        'Me.MsgResult.Text = Me.ReportViewer1.LocalReport.ReportPath
        'Me.ModalPopup.Show()
        ...
        Me.Opcion = UCase("Formulario único para la declaración de ") + objCd.GetNomDec(Me.Cla_Dec.Value)
    ...
    Public Function Tarifa(ByVal Cod_imp As String, ByVal tip As String) As String
        ...
        'Me.MsgResult.Text += Input_par + "<br>"
        'Me.ModalPopup.Show()
    ...
    Protected Sub Repeater1_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater1.ItemDataBound
        ...
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            If (CVMM = "S") Then
                If HdIMPTO.Value <> "" Then
                    Dim obj As BasesLiq = New BasesLiq
                    Dim dt As DataTable = obj.GetAforo(Me.HdTAG.Value, Me.Cla_Dec.Value, Me.Identificaciòn.Text, Me.AGravable.Text, Me.PGravable.Text, HdIMPTO.Value)
            ...
            If ((HdIsVb.Value = "S") And (HdCTAR.Value = "S")) Then
                ...
                If Me.Cla_Dec.Value = "02" Then
                    TxtValBas.Attributes.Add("onBlur", Me.fnTotalizar + "Resaltar_Off(this);")
                Else
                    TxtValBas.Attributes.Add("onBlur", Me.fnTotalizar + "Resaltar_Off(this);redondear_input(this," & Me.redondear.ToString & ");")
                End If
    ...
    Public Function Cargar_CODE(ByRef LP As LPCODE_CDEC()) As Boolean
        ...
        For i As Integer = 0 To Cant - 1
            ...
            If HdTICO.Value = "S" Then
                ...
                If ((Me.HdExtem.Value = "S") And (Me.HdTD.Value = "I")) Then
    ...
    Protected Sub BtnGuardarD_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) 'Handles BtnGuardarD.Click

        Me.EnableBtnGuardarD = False
        If Guardar_Dec() = True Then
            Me.EnableBtnGPDF = True
            Me.EnableBtnLiq = False
            Me.EnableBtnGuardarD = False
        Else

            Me.EnableBtnGPDF = False
            Me.EnableBtnGuardarD = True
    ...
    Protected Sub BtnLiq_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BtnLiq.Click
        Dim Tip_Decla As String = Me.HdDecTip.Value
        objCd = New CDeclaraciones(Me.Cla_Dec.Value)
        Me.Liquidar()
    ...
    Public Function LiquidarInicial() As Boolean
        ...
        For i As Integer = 0 To Cant - 1
            ...
            If HdIsVB.Value = "S" Then
                Dim TxtValBas As TextBox = DirectCast(Me.Repeater1.Items(i).FindControl("TxtValBas"), TextBox)
                LiqP(i).CODE_VABA = CDec(TxtValBas.Text.Replace("$", ""))
                LiqP(i).CODE_IMPTO = HdCimp.Value
                LiqP(i).CODE_TARI = HdTari.Value
            Else
                LiqP(i).CODE_VABA = Nothing
        ...
        For i As Integer = 0 To Cant2 - 1
            ...
            If HdTICO.Value = "I" Then
                'Me.Label18.Text = objCd.GetInteresMoraC(C_K, CDate(Me.HdFecLim.Value), CDate(Me.HdFecDec.Value))

                LiqP(j).CODE_VADE = objCd.GetInteresMoraC(C_K, CDate(Me.HdFecLim.Value), CDate(Me.HdFecDec.Value))
                'Me.Label18.Text = C_K.ToString + "#" + CDate(Me.HdFecLim.Value).ToString + "#" + CDate(Me.HdFecDec.Value).ToString
    ...
    Public Function LiquidarCorreccion() As Boolean
        ...
        For i As Integer = 0 To Cant2 - 1
            ...
            If HdTICO.Value = "D" Then
                'VALOR A PAGAR - MENOS VALOR PAGADO
                'Dim ValorPagado As Decimal = objCd.GetDecPtot(Me.dec_cor)


                LiqP(j).CODE_VADE = C_D - CDec(HdVALPAG_INI.Value)
                Tr += LiqP(j).CODE_VADE
                txtR.Text = LiqP(j).CODE_VADE
                Me.MsgResult.Text = "Valor a Pagar" + txtR.Text
                Me.ModalPopup.Show()
