<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PDeclaracionv01.aspx.vb" Inherits="Declaraciones_Estampillas_PDeclaracionv01" %>
                            ...
                            <p>
                                <table>
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="BtnGPDF" runat="server" 
                                                ImageUrl="~/images/BotonesWeb/BtnGenPDF.png" OnClick="BtnGPDF_Click" 
                                                ToolTip="Generar Documento PDF para Impresión y entrega en Entidad Recaudadora" /></td>
                                        <td style="width: 100px">
