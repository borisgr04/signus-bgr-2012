...
Partial Class Declaraciones_ICA_Declaracionv01
    ...
    ''------------ MANEJAR LAS ACTIVIDADES DEL
    Protected Sub CboAct_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim cbo As DropDownList = DirectCast(sender, DropDownList)
        Dim txttar As TextBox = DirectCast(Me.Repeater3.Items(CInt(cbo.CssClass)).FindControl("TxtTar"), TextBox)
        txttar.Text = cbo.SelectedValue
    End Sub
    'Configuración del Repeter 3
    Protected Sub Repeater3_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles Repeater3.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            Dim CboAcEc As DropDownList = DirectCast(e.Item.FindControl("CboAcEc"), DropDownList)
            CboAcEc.CssClass = irepeter.ToString
            irepeter += 1
        End If
    End Sub
