<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Declaracionv01.aspx.vb" Inherits="Declaraciones_ICA_Declaracionv01" %>
...
<body scroll="yes">
    <form id="form1" runat="server" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        ...
        <div  style="width:100%;height:600px;margin:0 auto 0 auto;border:solid 0,5pt;overflow:scroll;" > &nbsp;<div class="DecHeaderP">
        ...
        <div class="datasheet">
        <asp:UpdatePanel ID="UpdBaseG" runat="server">
            <ContentTemplate>
                 <asp:Repeater ID="Repeater3" runat="server" DataSourceID="ObjBG" >
                    <HeaderTemplate>
                            <table class="datatable" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="7"><b>III. BASE GRAVABLE</b></td>
                                </tr>
                                <tr>
                                    <td class="center">&nbsp;</td>
                                    <td class="center">&nbsp;</td>
                                    <td class="center"><b>ACTIVIDAD</b></td>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 40px;  text-align: right"> 
                                <asp:DropDownList ID="CboAcEc" AutoPostBack="true" OnSelectedIndexChanged="CboAct_SelectedIndexChanged" 
                                style="accelerator:true; font-size:7pt; width:100% " 
                                runat="server" DataSourceID="ObjACEC" 
                                DataTextField="ACEC_CODI" DataValueField="ACEC_TARI" 
                                Visible=<%#IIF(DataBinder.Eval(Container.DataItem, "COCD_ISVB")="S",True,False)%> 
                            ...
                            <td style="width: 50px;  text-align: right" >
                                ...
                                <ew:numericbox id="TxtTar" runat="server" autoformatcurrency="false" cssclass="TxtNum" Text="0"  MaxLength=4
                                    decimalsign="," 
                                    groupingseparator="." 
                                    Visible=<%#IIF(DataBinder.Eval(Container.DataItem, "COCD_ISVB")="S",True,False)%>></ew:numericbox>
                ...
                <FooterTemplate>
                    ...
                    <HeaderTemplate>
                            <table class="datatable" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td colspan="3"><b>IV. LIQUIDACIÓN PRIVADA</b></td>
                                </tr>
                                <tr id="itemPlaceholder" runat="server" />
                    </HeaderTemplate>
                    <ItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjBG" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetRenglones" TypeName="CDeclaraciones">
            <SelectParameters>
                <asp:ControlParameter ControlID="Cla_Dec" DefaultValue="01" Name="Cla_Dec" PropertyName="Value"
                    Type="String" />
                <asp:Parameter DefaultValue="BG" Name="Sec_Cod" Type="String" />
                <asp:ControlParameter ControlID="HdFODE" DefaultValue="" Name="Fode_Codi" PropertyName="Value"
                    Type="String" />
            </SelectParameters>
        </asp:ObjectDataSource>
        ...
        <asp:ObjectDataSource ID="ObjACEC" runat="server" SelectMethod="GetRecords" TypeName="ActiEcon">
        </asp:ObjectDataSource>
        ...
        <asp:UpdateProgress ID="UpProggBG" runat="server" AssociatedUpdatePanelID="UpdBaseG">
            <ProgressTemplate>
                <div class="Loading">
                    <img alt="" src="../../images/loading.gif" title="" />
                    Cargando …
